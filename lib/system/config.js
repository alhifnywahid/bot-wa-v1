...
global.status = Object.freeze({
   ...
   fitpornSystem: Func.texted('bold', 'Nsfw features have been disabled.'),
   pornInGroup: Func.texted('bold', 'The Nsfw feature has been turned off in this group.'),
   gameSystem: Func.texted('bold', 'Game features have been disabled.'),
   gameInGroup: 'Fitur permainan dalam grup ini dinonaktifkan.\n\n\nSilakan bergabung ke grup berikut untuk memainkan permainan: https://chat.whatsapp.com/HfbVjUdEIjY0Wg7FsYZIoj.',
   fitaiRespon: '*Mohon maaf, fitur tanya-jawab di dalam grup ini sedang dinonaktifkan.*\n\n*Namun, kamu masih bisa bergabung ke grup berikut untuk melakukan sesi tanya-jawab dengan bot kami:* https://chat.whatsapp.com/JpO7oMMgK975NMhJA7Qrnj.',
