...
// Owner number
global.owner = '6287877120437' // Owner name
global.owner_name = 'Ilham Saifuddin'
...
global.point = 500
// bof name
global.botname = `© Megachan v${global.version}`
// Footer text
global.footer = Func.texted('bold', 'Simlple WhatsApp Bot by MegaChan')
...
global.status = Object.freeze({
   ...
   gameInGroup: Func.texted('bold', 'Fitur Game di non-aktifkan di grup ini, Silahkan gabung ke grub berikut untuk bermain game : https://chat.whatsapp.com/HfbVjUdEIjY0Wg7FsYZIoj'),
