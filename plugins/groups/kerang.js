neoxr.create(async (m, {
     ...
     try {
      if (command == 'apakah') {
      	if (!text) return client.reply(m.chat, Func.example(prefix, command, 'luthfi sangat tampan dan cul'), m)
      	...
      	if (!text) return client.reply(m.chat, Func.example(prefix, command, 'luthfi dapat cewek idaman'), m)
      ...
      if (!text) return client.reply(m.chat, Func.example(prefix, command, 'ketampanan mas luthfi'), m)
