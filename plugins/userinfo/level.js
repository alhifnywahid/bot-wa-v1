...
neoxr.create(async (m, {
   ...
   client.sendFile(m.chat, await rank.build(), 'level.jpg', Func.texted('bold', `🚩 Untuk menaikkan level kamu harus mendapatkan poin lebih banyak, kamu bisa mendapatkan poin dengan bermain game.`), m)
}, {
   usage: ['level'],
   category: 'user info'
}, __filename)