neoxr.create(async (m, {
   ...
   if (jid == m.sender) return client.reply(m.chat, Func.texted('bold', '🚩 Can\'t send massage.to yourself.'), m)
   ...
   try {
      ...
      txt += `“${msg.trim()}”`
      await client.sendButtonText(p.jid, txt, global.botname, [{
         buttonId: `0x199`,
         buttonText: {
            displayText: 'Balas Pesan'
         },
         type: 1
      }]).then(() => {
